...
@endsection
@section('content')
<h1 class="h3 text-dark">Edit Data Kurir</h1>
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="/courier/{{$courier->id}}" method="POST" enctype="multipart/form-data" name="data_kurir" id="data_kurir">
            @csrf
            {{ method_field('PUT') }}
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="courier" id="courier" type="text" class="form-control"
                        placeholder="Contoh: JNE" value="{{$courier->courier}}">
