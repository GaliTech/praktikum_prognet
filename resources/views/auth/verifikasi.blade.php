            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background-image: url('{{ asset('img/login-user.jpg')}}');">
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4 text-sm text-gray-600">
                                    {{ __('Terima kasih telah mendaftar, silahkan lakukan verifikasi email!') }}
                                </div>
                        
                                @if (session('status') == 'verification-link-sent')
                                    <div class="mb-4 font-medium text-sm text-green-600">
                                        {{ __('Email verifikasi telah dikirim, silahkan cek email anda!') }}
                                    </div>
                                @endif
